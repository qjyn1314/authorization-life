...
//                String cacheUserToken = Formatter.of(SecurityContant.USER_DETAIL).add("token", userToken).format();
//                redisHelper.delete(cacheUserToken);
//                redisHelper.delete(Formatter.of(SecurityContant.TOKEN_STORE).add("userId", userDetail.getUserId().toString()).format());
//            }
