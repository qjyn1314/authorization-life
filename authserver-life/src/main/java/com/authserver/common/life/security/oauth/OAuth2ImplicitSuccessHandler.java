...
//
//@Slf4j
//public class OAuth2ImplicitSuccessHandler implements AuthenticationSuccessHandler {
//
//    private final RedirectStrategy redirectStrategy = new DefaultRedirectStrategy();
//
//    @Override
//    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException, ServletException {
//        log.debug("重定向implcit令牌");
...
//            String redirectUrl = Formatter.of(SecurityContant.IMPLICIT_REDIRECT_URI_FORMAT)
...
//        Assert.notNull(authorizationCodeRequestAuthentication.getAuthorizationCode(), "code不能为空。");
//        Assert.notNull(authorizationCodeRequestAuthentication.getAuthorizationCode().getTokenValue(), "token不能为空。");
