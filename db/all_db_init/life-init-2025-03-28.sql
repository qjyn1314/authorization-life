...
-- ----------------------------
-- Table structure for lsys_role_menu
-- ----------------------------
DROP TABLE IF EXISTS `lsys_role_menu`;
CREATE TABLE `lsys_role_menu`  (
  `role_menu_id` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '主键ID',
  `menu_id` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '资源编码',
  `role_code` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '角色编码',
  `role_id` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '角色ID',
  `tenant_id` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '0' COMMENT '租户ID',
  `version_num` bigint NULL DEFAULT 1 COMMENT '版本号',
  `created_by_user` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT '0' COMMENT '创建用户',
  `created_by_emp` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT '0' COMMENT '创建员工',
...
CREATE TABLE `lsys_role`  (
  ...
  `role_name` varchar(240) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '角色名称',
  `role_code` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '角色编码',
  `enable_flag` tinyint NOT NULL DEFAULT 0 COMMENT '角色是否启用',
  `sorted` bigint NULL DEFAULT 1 COMMENT '排序',
  `remark` varchar(3000) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '备注(授予的权限名称)',
  `tenant_id` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '0' COMMENT '租户ID',
  `version_num` bigint NULL DEFAULT 1 COMMENT '版本号',
  `created_by_user` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT '0' COMMENT '创建用户',
  `created_by_emp` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT '0' COMMENT '创建员工',
...
-- ----------------------------
-- Table structure for lsys_menu
-- ----------------------------
DROP TABLE IF EXISTS `lsys_menu`;
CREATE TABLE `lsys_menu`  (
  `menu_id` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '主键ID',
  ...
  `menu_name` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '菜单名称',
...
INSERT INTO `lsys_lov_value` VALUES ('29ac4961e56ce1f51b1c21b0e1f1415c', 'b182ed5bc05be17887f49e27c6584fbf', 'asdfges', 'MENU', '菜单', '菜单', '0', 1, 1, 1, '1', NULL, '2024-12-07 21:26:12', '1', NULL, '2024-12-07 21:34:34');
...
INSERT INTO `lsys_lov_value` VALUES ('6617a5b2806648e66abc765934c839d5', '47cab3a77b0329db09542a6fb28abc6c', 'FLAG_STATUS', 'true', '启用', '启用', '0', 2, 1, 1, '1', NULL, '2024-12-08 16:12:04', '1', NULL, '2024-12-08 17:33:48');
INSERT INTO `lsys_lov_value` VALUES ('796e6516618fedb49296bdb367b5ef9e', '47cab3a77b0329db09542a6fb28abc6c', 'FLAG_STATUS', 'false', '停用', '停用', '0', 1, 1, 1, '1', NULL, '2024-12-08 16:12:26', '1', NULL, '2024-12-08 17:33:53');
...
INSERT INTO `lsys_lov_value` VALUES ('b7d8fb71583191b82b527a3c97e30a53', 'b182ed5bc05be17887f49e27c6584fbf', 'asdfges', 'BUTTON', '按钮', '按钮', '0', 3, 1, 1, '1', NULL, '2024-12-07 21:26:21', '1', NULL, '2024-12-07 21:35:06');
...
INSERT INTO `lsys_lov_value` VALUES ('c61d14b6a2d8e106d115cdef5d79bb76', '1d3014b271089a267c77f8fb123a71fd', 'SYS_TEMP_TYPE', 'EMAIL', '邮件', '', '0', 7, 1, 1, '0', '0', '2024-10-26 22:27:40', '1', NULL, '2024-12-07 21:36:55');
...
INSERT INTO `lsys_lov` VALUES ('47cab3a77b0329db09542a6fb28abc6c', 'FLAG_STATUS', 'FIXED', '是否/启用停用', '是否/启用停用-true/false', 0, '0', 1, '1', NULL, '2024-12-08 16:10:39', '1', NULL, '2024-12-08 17:34:08');
INSERT INTO `lsys_lov` VALUES ('644fcf7e2063f79f4852cfdb73edd859', 'SYS_LOV_TYPE', 'FIXED', '值集类型', '值集的类型', 1, '0', 1, '0', '0', '2024-10-26 22:40:12', '1', NULL, '2024-12-07 20:48:17');
INSERT INTO `lsys_lov` VALUES ('b182ed5bc05be17887f49e27c6584fbf', 'sys_menu_type', 'FIXED', '菜单类型', '菜单类型', 1, '0', 1, '1', NULL, '2024-12-07 21:06:09', '1', NULL, '2024-12-08 20:19:50');
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '用户组表(scope)' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `liam_user`  (
  ...
  `username` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '用户编码',
  `real_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '用户姓名',
  `lang` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT 'zh_CN' COMMENT '语言,默认是中文',
  `locale` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT 'CN' COMMENT '地区,默认是中国',
  `gender` tinyint NULL DEFAULT 1 COMMENT '用户性别:1:男 2:女 3：未知',
  `hash_password` varchar(240) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '密码',
  `tel_area_code` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT '+86' COMMENT '电话区号。',
...
CREATE TABLE `liam_oauth_client`  (
  ...
  `client_secret_bak` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '备份密钥(源密码)',
  `tenant_id` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '0' COMMENT '租户ID',
  `version_num` bigint NULL DEFAULT 1 COMMENT '版本号',
  `created_by_user` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT '0' COMMENT '创建用户',
  `created_by_emp` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT '0' COMMENT '创建员工',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = 'oauth2客户端表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `liam_oauth_client` VALUES ('5', 'test.authorization.life', 'passport_test', '$2a$10$MMzpgdNcjGpKyKcYefsS.eYep472gJh4ABvkp6Uo18BUETxHVqxzW', 'authorization_code,refresh_token,client_credentials', 'TENANT', 'http://test.authorization.life/auth-redirect', 10800, 108000, '', '3MMoCFo4nTNjRtGZ', '0', 1, '0', '0', '2024-09-17 22:43:57', '0', '0', '2024-09-17 22:43:57');
INSERT INTO `liam_oauth_client` VALUES ('6', 'ui.authorization.life', 'passport_ui', '$2a$10$MMzpgdNcjGpKyKcYefsS.eYep472gJh4ABvkp6Uo18BUETxHVqxzW', 'authorization_code,refresh_token,client_credentials', 'TENANT', 'http://ui.authorization.life/auth-redirect', 10800, 108000, '', '3MMoCFo4nTNjRtGZ', '0', 1, '0', '0', '2024-09-17 22:43:57', '0', '0', '2024-09-17 22:43:57');
