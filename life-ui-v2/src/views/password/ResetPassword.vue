          ...
          <el-row>
            <el-col :span="20">
              <el-form label-width="100px" :model="loginForm" :rules="rules" ref="ruleForm">
                ...
                <el-form-item prop="password">
                  <el-input type="password" v-model="loginForm.validHashPassword" placeholder="确认新密码"></el-input>
                </el-form-item>
...
<script>
import {inspirational, resetPassword, sendEmailCodeResetPwd} from '@/api/login'
  ...
  methods: {
    ...
    refreshCode() {
      ...
      sendEmailCodeResetPwd(emailParams).then((res) => {
        ...
        Message.success("账号重置验证码已发送,请登录邮箱查收.")
