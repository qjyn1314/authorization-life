  ...
  <el-container>
    ...
    <el-header>
      <el-row :gutter="10">
        ...
        <el-col :span="3">
          <el-button @click="addData">模板默认接收人</el-button>
        </el-col>
        <el-col :span="3">
          <el-button @click="addData">模板对应接收人</el-button>
        </el-col>
        <el-col :span="3">
          <el-button round icon="el-icon-plus" @click="addData">发送系统公告</el-button>
        </el-col>
        <el-col :span="3">
          <el-button round icon="el-icon-plus" @click="addData">发送系统更新邮件</el-button>
        </el-col>
        <el-col :span="3">
